...
FIXED_PIPELINE_BINDING_IDLE_TIMEOUT_SEC = max(
    0, parse_int_env("FIXED_PIPELINE_BINDING_IDLE_TIMEOUT_SEC", 60)
)

METRICS_RECORDER = MetricsRecorder(
    METRICS_DIR,
    logger,
    enable_density_plot=HOST_METRICS_ENABLE_DENSITY_PLOT,
    density_bucket_seconds=HOST_METRICS_DENSITY_BUCKET_SEC,
)
