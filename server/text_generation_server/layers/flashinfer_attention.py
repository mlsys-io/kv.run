...
class FlashinferAttentionWrapper:
    ...
    def prepareBatchPrefill(
        self, prefillBatchPosition: KvCacheBatchPosition, page_len: int
    ):
    ...
    def completeBatchPrefill(self):
        self.prefill_wrapper.end_forward()

    def completeBatchDecode(self):
    ...
    def computeAttention(
        ...
        if decodeTotalSeqLen > 0:
            ...
            attn_output_decode = self._batchDecode(
                q, k, v, cacheData, decodeBatchPosition, rotaryParams
            )
